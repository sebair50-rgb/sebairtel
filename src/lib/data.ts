...
export const initialChats: Chat[] = [
  {
    ...
    messages: [
      ...
      { id: 6, user: 'أحمد محمد', avatar: '👨‍💻', type: 'text', text: 'بالفعل! انظر لهذا', time: '11:35 ص', status: 'delivered' },
      { id: 8, user: 'أنت', avatar: '👤', text: 'شكراً لمشاركته!', time: '11:36 ص', status: 'sent', replyTo: 6 },
    ],
  },
  {
    id: 2,
