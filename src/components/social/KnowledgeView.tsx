...
const KnowledgeView = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!textToAnalyze.trim()) {
            toast({ variant: 'destructive', title: 'حقل النص فارغ', description: 'الرجاء لصق نص أو رابط لتحليله.' });
            return;
        }
        ...
        try {
            ...
            toast({
                ...
                description: 'لم نتمكن من تحليل النص أو الرابط. يرجى المحاولة مرة أخرى.',
            });
        } finally {
            setIsLoading(false);
        }
        ...
        <div className="space-y-8 max-w-4xl mx-auto">
            <div className="text-center">
                ...
                <p className="mt-4 text-xl text-muted-foreground">
                    ألصق أي نص أو رابط - مقال، فكرة، سؤال - ودع الذكاء الاصطناعي يقدم لك تحليلًا معمقًا وملخصًا ذكيًا.
                </p>
            </div>
            ...
            <Card className="shadow-lg sticky top-0 z-10">
                 <CardContent className="p-4">
                    <form onSubmit={handleSubmit} className="flex flex-col items-center gap-2">
                         <Textarea
                            placeholder="الصق النص أو الرابط هنا لتحليله..."
            ...
            <div className="space-y-6">
                    ...
                    <Card key={content.id} className="animate-fade-in overflow-hidden">
                        ...
                        <CardContent className="space-y-6">
                             <div>
                                ...
                                <div className="text-muted-foreground bg-slate-100 p-4 rounded-md prose prose-sm max-w-none">
                                    <p>{content.summary}</p>
                                </div>
                            </div>
                             <div>
             ...
             {analyzedContent.length === 0 && !isLoading && (
                 <Alert variant="default" className="text-center p-8 border-dashed">
                    ...
                    <AlertDescription>
                        ستظهر التحليلات التي يقوم بها المساعد الذكي هنا. جرب لصق رابط مقال في الحقل أعلاه!
                    </AlertDescription>
                </Alert>
             )}
        </div>
